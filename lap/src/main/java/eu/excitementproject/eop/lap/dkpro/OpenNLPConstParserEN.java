...
/**
 * 
 * English constituency parsing pipeline, that relies on OpenNLP 
 * sent-breaker + tokenizer + tagger + parser. 
 * 
 ...
 *
 */
public class OpenNLPConstParserEN extends LAP_ImplBaseAE {

	public OpenNLPConstParserEN() throws LAPException {

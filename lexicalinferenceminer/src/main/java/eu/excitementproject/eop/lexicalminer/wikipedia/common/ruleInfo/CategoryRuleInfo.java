...
/**
 * Represents extra data about rule created by categories of a title
 * 
 * @author Alon Halfon
 * @since 29/04/12
 *
 */
public class CategoryRuleInfo extends BaseRuleInfo {
	/**
	 * 
	 */
	private static final long serialVersionUID = -3789853245903079344L;
	private String m_pageTitle;

	
	public CategoryRuleInfo(int pageID,String linkPageTitle)
	{
		super(pageID);

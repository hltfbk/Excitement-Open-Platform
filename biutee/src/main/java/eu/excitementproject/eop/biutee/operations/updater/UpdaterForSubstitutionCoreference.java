 ...
 *
 */
public class UpdaterForSubstitutionCoreference extends FeatureVectorUpdater<SubstitutionSubtreeSpecification>
{
	...
	{
		return featureUpdate.forSubstitutionCoreference(originalFeatureVector);
	}

...
public class ReasonableGuessCreator
{
	...
	public void create() throws TeEngineMlException, ClassifierException
	{
		...
		priorNegative.put(Feature.GAP_BASELINE_V1_MISSING_NODE_NAMED_ENTITY.getFeatureIndex(), new MeanAndStandardDeviation(-10, standardDeviation));
		priorNegative.put(Feature.GAP_BASELINE_V1_MISSING_NODE .getFeatureIndex(), new MeanAndStandardDeviation(-7, standardDeviation));
		priorNegative.put(Feature.GAP_BASELINE_V1_MISSING_NODE_NON_CONTENT_WORD .getFeatureIndex(), new MeanAndStandardDeviation(-3, standardDeviation));
		priorNegative.put(Feature.GAP_BASELINE_V1_MISSING_EDGE.getFeatureIndex(), new MeanAndStandardDeviation(-5, standardDeviation));
		
		priorNegative.put(Feature.GAP_BASELINE_V2_MISSING_LEMMA.getFeatureIndex(), new MeanAndStandardDeviation(-7, standardDeviation));
		priorNegative.put(Feature.GAP_BASELINE_V2_MISSING_NODE.getFeatureIndex(), new MeanAndStandardDeviation(-7, standardDeviation));
		priorNegative.put(Feature.GAP_BASELINE_V2_MISSING_RELATION.getFeatureIndex(), new MeanAndStandardDeviation(-10, standardDeviation));
		...
		priorPositive.put(Feature.GAP_BASELINE_V1_MISSING_NODE_NAMED_ENTITY.getFeatureIndex(), new MeanAndStandardDeviation(-1, standardDeviation));
		priorPositive.put(Feature.GAP_BASELINE_V1_MISSING_NODE .getFeatureIndex(), new MeanAndStandardDeviation(-1, standardDeviation));
		priorPositive.put(Feature.GAP_BASELINE_V1_MISSING_NODE_NON_CONTENT_WORD .getFeatureIndex(), new MeanAndStandardDeviation(-1, standardDeviation));
		priorPositive.put(Feature.GAP_BASELINE_V1_MISSING_EDGE.getFeatureIndex(), new MeanAndStandardDeviation(-1, standardDeviation));
		
		priorPositive.put(Feature.GAP_BASELINE_V2_MISSING_LEMMA.getFeatureIndex(), new MeanAndStandardDeviation(-1, standardDeviation));
		priorPositive.put(Feature.GAP_BASELINE_V2_MISSING_NODE.getFeatureIndex(), new MeanAndStandardDeviation(-1, standardDeviation));
		priorPositive.put(Feature.GAP_BASELINE_V2_MISSING_RELATION.getFeatureIndex(), new MeanAndStandardDeviation(-1, standardDeviation));

 ...
 *
 */
public class UpdaterForSubstituteMultiWord extends FeatureVectorUpdater<SubstituteNodeSpecificationMultiWord>
{
	...
	{
		return featureUpdate.forSubstitutionMultiWord(originalFeatureVector,specification);
	}

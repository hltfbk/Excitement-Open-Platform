...
public class ClassifierFactory
{
	...
	public LinearTrainableStorableClassifier getF1Classifier() throws ClassifierException
	{
		...
		gradientAscentClassifier.restrict(BiuteeConstants.INCREASE_PARAMETERS_VALUE_IN_F1_CLASSIFIER, RTESystemsUtils.getGlobalFeatureIndexes());
...
//	};
	...
	protected static LogisticRegressionClassifier createDefaultLogisticRegressionClassifier()
	{
		...
		if (BiuteeConstants.RESTRICT_SEARCH_CLASSIFIER_DURING_TRAINING)
		{
			...
			lrClassifier.restrict(BiuteeConstants.INCREASE_PARAMETERS_VALUE_IN_SEARCH_CLASSIFIER, RTESystemsUtils.getGlobalFeatureIndexes());
		}
		else
		{

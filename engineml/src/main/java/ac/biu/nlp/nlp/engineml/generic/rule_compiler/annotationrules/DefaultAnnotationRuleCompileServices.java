...
import ac.biu.nlp.nlp.engineml.generic.truthteller.representation.CtRuleAnnotationValue;
import ac.biu.nlp.nlp.engineml.generic.truthteller.representation.NuRuleAnnotationValue;
import ac.biu.nlp.nlp.engineml.generic.truthteller.representation.PtRuleAnnotationValue;
...
public class DefaultAnnotationRuleCompileServices implements AnnotationRuleCompileServices<ExtendedInfo, ExtendedNode, ExtendedConstructionNode, BasicRuleAnnotations>	 
{
	...
	public void performPartialMappings(	List<PartialAlignment<ExtendedConstructionNode, BasicRuleAnnotations>> partialAlignments)	throws AnnotationCompilationException 
	{
		...
		{		
			...
			} catch (ac.biu.nlp.nlp.engineml.generic.truthteller.representation.AnnotationValueException e) {

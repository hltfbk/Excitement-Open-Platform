...
import ac.biu.nlp.nlp.engineml.generic.rule_compiler.charger.GenericAlignment;
import ac.biu.nlp.nlp.engineml.generic.rule_compiler.charger.RuleBuildingUtils;
...
public class CgxEntailmentRuleCompiler<I extends Info, N extends AbstractNode<I, N>, CN extends AbstractConstructionNode<I, CN>> 
{
	 ...
	 */
	public Rule<I, N> makeRule(String ruleText) throws EntailmentCompilationException
	{
		Rule<I, N> rule = null;
	 ...
	 * @throws EntailmentCompilationException 
	 */
	private Rule<I, N> makeNormalRule(String cgxText, boolean isExtraction) throws EntailmentCompilationException
	{
		try {
			...
			Rule<I, N> rule = buildRule(lhsRoot, rhsRoot, nodeAlignments, isExtraction);
	 ...
	 * @return
	 */
	private Rule<I, N> buildRule(CN oldLhsRoot, CN oldRhsRoot, BidirectionalMap<CN, CN> nodeAlignments, boolean isExtraction) {
		...
		return new Rule<I, N>(newLhsRoot, newRhsRoot, newAlignments, isExtraction);
	}

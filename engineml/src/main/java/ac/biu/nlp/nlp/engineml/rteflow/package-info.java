 ...
 * The most important interface here is {@link ac.biu.nlp.nlp.engineml.rteflow.macro.TextTreesProcessor},
 ...
 * </OL>
 * All of this is done by {@link ac.biu.nlp.nlp.engineml.rteflow.macro.TextTreesProcessor}.
 * <BR>
 * How {@link ac.biu.nlp.nlp.engineml.rteflow.macro.TextTreesProcessor} works?
 ...
 * {@link ac.biu.nlp.nlp.engineml.rteflow.micro.TreesGeneratorByOperations}.<BR>
 * Now, let's go on.
 * The {@link ac.biu.nlp.nlp.engineml.rteflow.micro.TreesGeneratorByOperations}
 * is given a tree. But in addition it is given a list of operation-items
 * (which are types of operations). The class {@link ac.biu.nlp.nlp.engineml.rteflow.micro.TreesGeneratorByOperations}
 ...
 * to the currently hard-coded class {@link ac.biu.nlp.nlp.engineml.rteflow.macro.DefaultOperationScript}.
 ...
 * class {@link ac.biu.nlp.nlp.engineml.rteflow.micro.PathObservations}, so if

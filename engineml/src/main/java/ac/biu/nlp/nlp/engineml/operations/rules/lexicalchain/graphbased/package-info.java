 ...
 * {@link ac.biu.nlp.nlp.engineml.operations.rules.ByLemmaPosLexicalRuleBase} with
 * generic parameter {@link ac.biu.nlp.nlp.engineml.operations.rules.lexicalchain.ChainOfLexicalRules}.
 * <BR>
 * That implementation was programmed by Eyal Shnarch, using PLIS (Probabilistic Lexical
 * Inference System). {@link ac.biu.nlp.nlp.engineml.operations.rules.lexicalchain.graphbased.PlisRuleBase} 

...
public class RuleToConllCoverter {
	...
	/**
	 * Print a {@link Rule} to CoNLL format String:<br>
	 ...
	 * @throws ConllConverterException
	 */
	public static <I extends Info, N extends AbstractNode<I, N>> String ruleToConll(Rule<I, N> rule, RuleConllStringConverter<I, N> nodeToConllStringConvertor) 
		throws ConllConverterException
	{
		if (rule == null)
	...
	private static <I extends Info, N extends AbstractNode<I, N>> Map<N, Integer> mapNodesToConllIds(Rule<I,N> rule)
	{

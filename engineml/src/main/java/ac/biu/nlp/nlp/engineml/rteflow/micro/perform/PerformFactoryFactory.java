...
import ac.biu.nlp.nlp.engineml.rteflow.macro.multiword_namedentity_utils.MultiWordNamedEntityUtils;
import ac.biu.nlp.nlp.engineml.rteflow.micro.OperationsEnvironment;
import ac.biu.nlp.nlp.engineml.rteflow.micro.perform.dummy.DummyPerformFactory;
...
public class PerformFactoryFactory
{
	...
	public List<PerformFactory<? extends Specification>> getFactory(SingleOperationItem item) throws TeEngineMlException, OperationException, PluginException
	{
		...
		{
			return new SingleItemList<PerformFactory<? extends Specification>>(new RulePerformFactory(operationsEnvironment.getHypothesisTemplates(), operationsEnvironment.getHypothesisLemmasOnly()));
		}

...
public class EntailmentRuleBuildingUtils {
		...
		void addReversedRules(Set<RuleWithConfidenceAndDescription<I, N>> rulesWithCD, String cgxText) throws EntailmentCompilationException 
	{
		if (cgxText.toLowerCase().contains(Constants.BIDIRECTIONAL_LABEL))
		{
			...
			{
				Rule<I, N> reversedRule = reverseRule(ruleWithCD.getRule());
	 ...
	 * @throws EntailmentCompilationException 
	 */
	public static <I extends Info, S extends AbstractNode<I,S>> void sanityCheckRule(Rule<I,S> rule) throws EntailmentCompilationException
	{
		if (rule == null)
	 ...
	 * @return
	 */
	private static <I, S extends AbstractNode<I,S>> Rule<I,S> reverseRule(Rule<I,S> rule)
	{
		return new Rule<I, S>(

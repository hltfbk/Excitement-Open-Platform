...
public class EfficientlyCorrectHtlTreeLearnerWeird extends HighToLowTreeLearner {

	private Logger logger = Logger.getLogger(EfficientlyCorrectHtlTreeLearnerWeird.class);
	
	public EfficientlyCorrectHtlTreeLearnerWeird(NodeGraph ioGraph,MapLocalScorer iLocalModel, double edgeCost) throws Exception {
		super(ioGraph, iLocalModel, edgeCost);
	}
	
	public EfficientlyCorrectHtlTreeLearnerWeird(double edgeCost)  {
		super(edgeCost);
	}
	...
	public void learn() throws Exception {
		//init with htl-tree
		double origEdgeCost = m_edgeCost;
		m_edgeCost = origEdgeCost-0.1;
		super.learn();
		m_edgeCost = origEdgeCost;
		//perform iterations
		performIterativeProcedure();
	}
	
	void performIterativeProcedure() throws Exception {

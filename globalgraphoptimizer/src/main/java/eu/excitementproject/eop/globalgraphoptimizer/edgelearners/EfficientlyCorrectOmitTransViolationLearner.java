...
public class EfficientlyCorrectOmitTransViolationLearner extends OmitTransViolationLearner{

	private Logger logger = Logger.getLogger(EfficientlyCorrectOmitTransViolationLearner.class);
	
	public EfficientlyCorrectOmitTransViolationLearner(NodeGraph ioGraph,MapLocalScorer iLocalModel, double edgeCost) throws Exception {
		super(ioGraph, iLocalModel, edgeCost);
	}
	

	public EfficientlyCorrectOmitTransViolationLearner(double edgeCost) {
		super(edgeCost);
	}

...
public class EfficientlyCorrectTransClosureLearner extends TransClosureLearner {

	private Logger logger = Logger.getLogger(EfficientlyCorrectTransClosureLearner.class);
	
	public EfficientlyCorrectTransClosureLearner(NodeGraph ioGraph,MapLocalScorer iLocalModel,double edgeCost) throws Exception {
		super(ioGraph, iLocalModel, edgeCost);
	}

	public EfficientlyCorrectTransClosureLearner(double edgeCost) {
		super(edgeCost);
	}
	...
	public void learn() throws Exception {
		...
		if(m_nodeGraph.getGraph().getNode(1).description().equals("<_ know as::drug_2::drug_1>"))
			System.out.print("");

 ...
 */
public class EditDistanceEDAwRedisTest {
	...
	public void test() {
		...
		logger.info("testing EditDistanceEDAwRedis ...");
		testItalian();
//		testEnglish();
//		testGerman();
	...
	public void testItalian() {
		...
		EditDistanceEDAwRedis<EditDistanceTEDecision> editDistanceEDA = 
				new EditDistanceEDAwRedis<EditDistanceTEDecision>();
		
		try {
			
			File configFile = new File("./src/main/resources/configuration-file/EditDistanceEDAwRedis_IT.xml");
//			File testDir = new File("./src/main/resources/data-set/ITA/test/");
			File testDir = new File("/tmp/eop-eda-exp/ALMA/test_little/");
			...
			logger.info("Done training. Initializing EDA for testing");
			...
			logger.info("Processing file from directory " + testDir);
			
			for (File xmi : (testDir.listFiles())) {
				
				logger.info("Processing file " + xmi);
			...
			File annotatedFileName = new File("/tmp/redis/EditDistanceEDA_IT_Result.txt");
//			String evaluationFileName = "/tmp/redis/EditDistanceEDA_IT_Eval.xml";

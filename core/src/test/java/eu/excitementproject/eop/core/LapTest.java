...
/**
* Tests LAPs
* It annotates 3 small data sets by using OpenNLP tagger 
*/
public class LapTest {
		...
		public void testLAP_IT() {
			...
			inputFile = new File("./src/test/resources/data-set/Italian_dev_small.xml");
			...
			inputFile = new File("./src/test/resources/data-set/Italian_test_small.xml");
		...
		public void testLAP_EN() {
			...
			// generate XMI files for the training data
			inputFile = new File("./src/test/resources/data-set/English_dev_small.xml");
			...
			// generate XMI files for the testing data
			inputFile = new File("./src/test/resources/data-set/English_test_small.xml");
		...
		public void testLAP_DE() {
			...
			// generate XMI files for the training data
			inputFile = new File("./src/test/resources/data-set/German_dev_small.xml");
			...
			// generate XMI files for the testing data
			inputFile = new File("./src/test/resources/data-set/German_test_small.xml");

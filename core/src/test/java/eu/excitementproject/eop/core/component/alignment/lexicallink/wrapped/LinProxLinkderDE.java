...
public class LinProxLinkderDE {
	...
	public void test() {
		...
		try {
			...
			TreeTaggerDE lemmatizer = null; 
			try 
			{
				lemmatizer = new TreeTaggerDE(); 
			...
			// prepare the alinger 
			AlignmentComponent wnLinker = new LinProxLinkerDE(); 
			
			String t1 = "Ich habe ein brot."; 
			String h1 = "Er hat etwas zum essen."; 

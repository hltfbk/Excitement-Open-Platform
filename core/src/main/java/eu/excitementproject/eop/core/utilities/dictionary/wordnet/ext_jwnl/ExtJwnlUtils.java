...
public class ExtJwnlUtils
{
	...
	/**
	 * Return the ExtJwnl {@link PointerType} matching the given {@link WordNetRelation}. Notice that some {@link WordNetRelation}s have no implementation in ExtJwnl, and return 
	 * null.
	 * @param relation
	 * @return

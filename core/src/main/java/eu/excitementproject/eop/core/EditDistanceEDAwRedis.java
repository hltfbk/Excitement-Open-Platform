...
public class EditDistanceEDAwRedis<T extends TEDecision>
	 ...
	 */
	private FixedWeightEditDistancewRedis component;
	 ...
	 */
	public FixedWeightEditDistancewRedis getComponent() {
	...
	public EditDistanceEDAwRedis() {
		...
		logger.info("Creating an instance of Edit Distance EDA with Redis-based LR");
	...
	public void shutdown() {
		...
		if (component != null)
			((FixedWeightEditDistancewRedis)component).shutdown();

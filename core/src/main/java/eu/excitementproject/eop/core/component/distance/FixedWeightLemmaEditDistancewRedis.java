 ...
 * 
 * @author Roberto Zanoli & Vivi@fbk
 * 
 */
public class FixedWeightLemmaEditDistancewRedis extends FixedWeightEditDistancewRedis {
     ...
     */
    public FixedWeightLemmaEditDistancewRedis() {
     ...
     * 
	 */
    public FixedWeightLemmaEditDistancewRedis(double mMatchWeight, double mDeleteWeight, double mInsertWeight, double mSubstituteWeight, boolean stopWordRemoval, String language, Map<String,String> resources) throws ConfigurationException, ComponentException {
	 ...
	 * 
	 */
    public FixedWeightLemmaEditDistancewRedis(CommonConfig config) throws ConfigurationException, ComponentException {
    ...
    public String getComponentName() {
    	...
    	return "FixedWeightLemmaEditDistancewRedis";

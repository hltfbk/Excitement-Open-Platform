 ...
 *
 */
public class SimilarityStorageBasedLexicalResource implements LexicalResource<EmptyRuleInfo> {
	...
	protected List<LexicalRule<? extends EmptyRuleInfo>> getRulesForLeft(String lemma, PartOfSpeech pos, RuleDirection ruleDirection) throws LexicalResourceException {
		try {
			LemmaPosBasedElement element1 = new LemmaPosBasedElement(new LemmaPos(lemma, (pos == null ? null : pos.getCanonicalPosTag())));
			List<LexicalRule<? extends EmptyRuleInfo>> ret = new LinkedList<LexicalRule<? extends EmptyRuleInfo>>();
	 ...
	 */
	@Override
	public List<LexicalRule<? extends EmptyRuleInfo>> getRules(String leftLemma, PartOfSpeech leftPos, String rightLemma, PartOfSpeech rightPos) throws LexicalResourceException {
		try {
			List<LexicalRule<? extends EmptyRuleInfo>> ret = new LinkedList<LexicalRule<? extends EmptyRuleInfo>>();

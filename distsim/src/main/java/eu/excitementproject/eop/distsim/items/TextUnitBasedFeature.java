...
public class TextUnitBasedFeature extends DeafaultFeature<Integer> {
	...
	public TextUnitBasedFeature(int textUnitID) {
		super(textUnitID);
	}

	public TextUnitBasedFeature(int textUnitID, AggregatedContext context) {
		super(textUnitID, context);
	}

	public TextUnitBasedFeature(int textUnitID, int id, long count) {
		super(textUnitID,id,count);

	}
	
	public TextUnitBasedFeature(int textUnitID, AggregatedContext context, int id, long count) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TextUnitBasedFeature other = (TextUnitBasedFeature) obj;

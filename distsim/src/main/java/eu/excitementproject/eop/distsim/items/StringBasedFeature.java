 ...
 *
 */
public class StringBasedFeature extends DeafaultFeature<String> {

	private static final long serialVersionUID = 1L;


	public StringBasedFeature(String data) {
		super(data);
	}

	public StringBasedFeature(String data, AggregatedContext context) {
		super(data, context);
	}

	public StringBasedFeature(String data, int id, long count) {
		super(data,id,count);
	}
	
	public StringBasedFeature(String data, AggregatedContext context, int id, long count) {
